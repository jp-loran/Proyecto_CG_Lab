...
int main()
{
	...
	camera = Camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 2.0f, 0.2f);
	...
	Dado12_M = Model();
	Dado12_M.LoadModel("Models/dado.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*dado 12 lados*/
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 20.0f, 2.0f));
		model = glm::rotate(model, 0 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Dado12_M.RenderModel();
		glUseProgram(0);
